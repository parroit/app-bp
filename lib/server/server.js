...
function route(request, response) {
    ...
    if (routed) {
        ...
        function render(controllerResults, onEnd) {
            var viewName = "../view/" + controller.name + "/" + dest[1].replace("jinja:", "");
        ...
        render.onError = function (err, stacktrace) {
            ...
            renderErrTemplate(500, "../view/error", args);
        }
        ...
        renderErrTemplate(404, "../view/notfound", {
