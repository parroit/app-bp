...
function Validator(model){
    ...
    Valda.prototype.maxLen = function(len) {
        if (this.str.length>len){
            this.error(this.msg || "Massimo "+len+" caratteri.");
...
Validator.prototype.check =function(fieldName,msg){
    this.checkedField=fieldName;
    return this.v.check(this.model[fieldName],msg);
};
