...
(function () {
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            buttons.code = makeButton("wmd-code-button", "Code Sample - Ctrl+K", "icon-coffee", bindCommand("doCode"), group2);
            ...
            buttons.hr = makeButton("wmd-hr-button", "Horizontal Rule - Ctrl+R", "icon-hand-down", bindCommand("doHorizontalRule"), group3);
