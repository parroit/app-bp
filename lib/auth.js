        ...
        collection.insert(
            ...
            function () {
                ...
                var mailOptions = {
                    ...
                    subject: "Conferma dell'iscrizioe al sito eban software", // Subject line
...
exports.authenticated= function (callback) {
    function action() {
        if(this.request.session.user==null) {
            this.unauthorized();
        }else
...
exports.onAppStart=function(){
    this.onCollection('users', function (client,collection,client){
                ...
                collection.insert(
                    {
                        _id:"parroit",
                        username:"parroit",
                        password:getPasswordHash("parroit","porta111"),
                        nome:"andrea",
                        cognome:"parodi",
                        ruolo:"adm",
